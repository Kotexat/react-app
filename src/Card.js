...
export default function Card(props) {
    ...
    return (
        <div style={{ width: 300, height: 400, backgroundColor: '#d79922', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', borderRadius: '30px', position:"relative" }}>
            <button className={`btn-${props.id}`}  onClick={props.statusisShecvla} style={{ width: "150px" , height : "50px", color:"white", backgroundColor:"red", fontSize : "20px", top:"30px" , left:"120px" , borderRadius:"30px" , cursor:"pointer", border:"none", fontWeight:"bold", position:"absolute"}}>{props.addBasket}</button>
